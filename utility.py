...
def get_leaderboards_names_static():
  return ['terra', 'tachyon', 'shell', 'bob', 'light', 'deflector', 'siab', 'actuator', 'monocle', 'metronome', 'feather', 'chalice', 'compass', 'rainstick', 'beak', 'lens', 'medallion', 'gusset', 'ankh', 'brooch', 'vial', 'necklace', 'totem', 'cube', 'gold', 'tau', 'titanium', 'clarity', 'lunar', 'prophecy', 'life', 'quantum', 'dilithium', 'soul']
